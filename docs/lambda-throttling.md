...
A floor of 10 guarantees the function can absorb a small traffic spike even during very low-traffic windows, reserving a sane baseline without provisioning idle capacity.
