...
A floor of 10 guarantees the function can absorb moderate traffic spikes even during very low-traffic windows, providing stronger baseline protection against sudden load increases without over-provisioning idle capacity.
