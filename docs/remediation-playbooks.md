...
- A minimum floor of `10` so that traffic spikes never drop the function below a conservative baseline buffer.
- A `1.25` safety multiplier over observed average RPS to absorb realistic traffic variance.
